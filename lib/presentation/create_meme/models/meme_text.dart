...
class MemeText extends Equatable {
  ...
  MemeText copyWithChangedFontSettings(
      final Color newColor, final double newFontSize, final FontWeight newFontWeight) {
    return MemeText(id: id, text: text, color: newColor, fontSize: newFontSize, fontWeight: newFontWeight);
  }
